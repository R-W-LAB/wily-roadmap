...
- Child Phase 15-7 opened draft workflow PRs for all four initial repositories, then blocked until Azure SSH access and live credentials exist.
...
- Merge the workflow PRs after `WILY_BOARD_URL` and `WILY_BOARD_SECRET` are available as repo or org secrets:
