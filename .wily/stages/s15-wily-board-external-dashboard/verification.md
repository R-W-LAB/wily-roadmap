...
- `uv run pytest -q` in `wily-board` passes: 21 tests.
...
- Remaining unchecked acceptance item: a real board PR-write action against an appropriate Wily state branch.
